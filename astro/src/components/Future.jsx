...
const icons = [Zap, Shield, Sparkles, Rocket];

export default function Future({ lang }) {
            ...
            <AnimatePresence mode="wait">
                ...
                >
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                        <a href="https://www.instagram.com/fcoterroba" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center px-8 py-4 bg-primary hover:bg-blue-600 text-white rounded-full font-bold transition-all shadow-lg shadow-primary/20 hover:shadow-primary/40 hover:-translate-y-1">
                            {t.followInstagram}
                        </a>
                        <a href="https://www.linkedin.com/company/vivifind/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center px-8 py-4 bg-white border border-slate-200 text-slate-700 hover:bg-slate-50 rounded-full font-bold transition-all hover:-translate-y-1">
                            {t.followLinkedIn}
                        </a>
                    </div>
                </motion.div>
